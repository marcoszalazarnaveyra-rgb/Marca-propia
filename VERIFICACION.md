...
- Search Console: propiedad de dominio verificada por DNS; sitemap procesado con una página descubierta; prueba en vivo «La URL está disponible para Google» y solicitud de indexación aceptada el 24/09/2026. La portada aún no figuraba en el índice durante la primera inspección, antes del rastreo.
